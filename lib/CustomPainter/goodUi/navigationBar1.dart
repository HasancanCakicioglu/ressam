...
class navigationBar1class extends StatefulWidget {
  @override
  _navigationBar1classState createState() => _navigationBar1classState();
}

class _navigationBar1classState extends State<navigationBar1class> {
  int currentIndex = 0;
