...
import 'package:ressam/Flame/simplfier/game/actors/platform.dart';
...
class Player extends SpriteComponent with CollisionCallbacks, KeyboardHandler {
  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    if (other is Platform) {
      //print("interpoint = ${intersectionPoints}");
      ...
      if (intersectionPoints.length == 2) {
        ...
        print("absolute = $absoluteCenter   ||| mid = $mid   ||| collision = $collisionNormal || seperate = $separationDistance");
