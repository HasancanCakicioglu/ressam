...
import 'package:ressam/Flame/testFlame/commons/ember.dart';
...
class DraggableSquare extends Ember with Draggable {
  ...
  bool onDragStart(DragStartInfo info) {
    ...
    print("info = ${info.eventPosition.game}");
    print("drag = $dragDeltaPosition");
    return false;
  }
  ...
  bool onDragUpdate(DragUpdateInfo info) {
    ...
    print("info.eventPosition.game - dragDeltaPosition = ${info.eventPosition.game - dragDeltaPosition}");
    return false;
  }
