...
class ScrollExample extends FlameGame with ScrollDetector {
  ...
  void onScroll(PointerScrollInfo info) {
    target = position + info.scrollDelta.game * 1;
    print("target = ${target = position + info.scrollDelta.game * 1}");
    print("scroolDelta = ${info.scrollDelta.game * 1}");
    print("target.lenght = ${target?.length}");
