...
class _MyHomePageState extends State<MyHomePage>
  ...
  _update() {
    //print(worldController.lastElapsedDuration.toString() +" --- "+ "${lastUpdateCall}");
    //print("${lastUpdateCall}" +" --- "+ worldController.lastElapsedDuration.toString());
    try {
      ...
      //print("runDistance = ${runDistance} --- runVelocity = ${runVelocity}");
